    ...
    public partial class myDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BougthItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BougthItems_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BougthItems_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BougthItems_ApplicationUserId",
                table: "BougthItems",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BougthItems_ProductId",
                table: "BougthItems",
                column: "ProductId");
